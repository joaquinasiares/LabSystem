<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PromedioVentasMensualesClientes.aspx.cs" Inherits="LabSystemPP3.Pantalla_Informes.PromedioVentasMensualesClientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlCargarInforme" runat="server"
        ...
        SelectCommandType="StoredProcedure" SelectCommand="selectPromedioVentasMensualesCliente">
        <SelectParameters>
