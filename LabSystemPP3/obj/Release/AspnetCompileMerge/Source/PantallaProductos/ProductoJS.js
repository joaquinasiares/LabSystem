...
function mostrarOpciones() {
    ...
    const modal = document.getElementById("cuerpoOP");
    const modalcont = document.getElementById("contenedorOP");
    if (modal && modalcont) {
        modal.style.opacity = 1;
        modal.style.visibility = "visible";
        modalcont.style.visibility = "visible";
...
document.getElementById("LblCerrarOpcion").addEventListener('click', function () {
    const modal = document.getElementById("cuerpoOP");
    const modalcont = document.getElementById("contenedorOP");
    modal.style.opacity = 0;
    modal.style.visibility = "hidden";
