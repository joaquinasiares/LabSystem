...
document.getElementById("<%= lblCerrar.ClientID %>").addEventListener('click', function () {
    const modal = document.getElementById("<%= VentanaUPD.ClientID %>");
    const modalcont = document.getElementById("<%= modal-container.ClientID %>");
    modal.style.opacity = 0;
    modal.style.visibility = "hidden";
    modalcont.style.visibility = "hidden";
    modalcont.style.zIndex = 0;
